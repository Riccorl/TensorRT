...
from MT5.frameworks import MT5FHuggingFace
...
from MT5.export import MT5DecoderONNXFile, MT5EncoderONNXFile
...
class MT5TRT(TRTInferenceCommand):
    ...
    def execute_inference(
        ...
        tokenizer = MT5Tokenizer.from_pretrained(metadata.variant)
